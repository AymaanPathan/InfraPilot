          ...
          >
            <div className="flex items-start justify-between mb-3">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-slate-900/50 rounded-lg group-hover:scale-110 transition-transform duration-200">
                ...
                <div>
                  ...
                  {namespace.age && (
                    <p className="text-xs text-slate-500">{namespace.age}</p>
                  )}
                </div>
              </div>
                ...
                <div className="flex flex-wrap gap-1">
                  {Object.entries(namespace.labels)
                    ...
                    .map(([key, value], lIndex) => (
                      <code
                        key={lIndex}
                        className="px-1.5 py-0.5 bg-slate-900/50 text-slate-400 rounded text-xs"
                      >
                        {key}
                      </code>
                    ))}
